...
class Imposto(object):
	...
	def __init__(self, outro_imposto = None): #Construtor
...
class Template_de_imposto_condicional(Imposto):
	...
	__metaclass__ = ABCMeta  #Definindo como Classe Abstrata
...
def IPVX(metodo_ou_funcao): #Decorator
	def wrapper(self, orcamento): #Empacotador
